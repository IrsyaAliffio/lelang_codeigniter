...
<head>
    ...
    <title>Lelang.ID - Register</title>
    ...
    <main class="main">
        ...
        <div class="formulir">
            <div class="bg-succes">
                ...
                <a href="rigester.php" class="active"><h1>Register</h1></a>
            </div>
            <div class="form">
                <main>
                <div class="txtb">
                ...
                <div class="txtb">
                    ...
                    <span class="eye" onclick="myfunction1()">
                        <i id="hiden3" class="fa fa-eye"></i>
                        <i id="hiden4" class="fa fa-eye-slash"></i>
                    </span>
                </div>
                <div class="btn">
...
<script>
    ...
    function myfunction1(){
        ...
        var y1 = document.getElementById("hiden3");
        var z1 = document.getElementById("hiden4");
